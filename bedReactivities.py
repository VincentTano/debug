...
def combineCoverage(cov,cov5,relPos_in,beds_in,strand,sequence,USE_BED_NAME = True): #input: coverage 5'coverage arrays and a 2darray of bed regions to extract. relPos format: [[relStart,relStop],...]
