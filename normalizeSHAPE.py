...
confminDepth=50 #positions below this depth will be reported as -999 reactivity ("no data")
confmaxBackground=0.3
hmmDepth=50 #depth of total coverage below which it is considered a potential "gap" in hmm
#if len(sys.argv)>4:
...
def normalizeSHAPEmain(cov,cov5,trimEnds=True):
    ...
    print(profiles) #print(profiles[35:40])
